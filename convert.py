...
length = {# TRANS: https://en.wikipedia.org/wiki/Metre
          _('Meters (m)'): (1, 1),
...
area = {# TRANS: https://en.wikipedia.org/wiki/Metre
        _('Meter'): (1, 1, 2),
...
volume = {_('Meter'): (1, 1, 3),
          ...
          _('Liter'): (0.001, 1000),
          # TRANS: https://en.wikipedia.org/wiki/Litre#SI_prefixes_applied_to_the_litre
...
speed = {# TRANS: https://en.wikipedia.org/wiki/Kilometres_per_hour
...
time = {# TRANS: https://en.wikipedia.org/wiki/Day
        _('Day'): (1, 1),
...
temp = {# TRANS: https://en.wikipedia.org/wiki/Celsius
        _('Celsius'): (1, 1),
